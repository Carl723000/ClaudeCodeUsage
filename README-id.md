...
- **Diproses** = input + output, **baru (fresh)** = input non-cache + output, **cached input** tetap bagian dari input, dan reasoning bagian dari output. Biaya Codex dalam dolar tidak diestimasi; Claude / Codex / Compare mempertahankan makna penghitungan tiap penyedia secara terpisah.
- Tiga halaman utama memakai bahasa visual dashboard yang sudah ada. **Ringkasan** menampilkan cakupan tugas terbaru / 7 hari terakhir / 30 hari terakhir / semua waktu beserta ringkasan, tren, komposisi, batas terakhir diamati, dan tugas terbaru. **Jelajahi** menyediakan Proyek, Sesi, serta Model & effort dengan pencarian, filter, pengurutan, penelusuran, dan garis keturunan induk/anak. **Rekomendasi optimasi** mengikuti cakupan yang dipilih.
