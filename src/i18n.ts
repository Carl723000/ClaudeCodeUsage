...
const PROVIDERS: Record<SupportedLanguage, ProviderTranslations> = {
  ...
  'de-DE': providerTranslations(
    { claude: 'Claude', codexBeta: 'Codex Beta', compare: 'Vergleichen' },
    {
      ...
      unnamedSession: 'Unbenannte Sitzung', unidentifiedProject: 'Nicht identifiziertes Projekt', parentThread: 'Übergeordnet', searchThreads: 'Sitzungen suchen', all: 'Alle', localDirectory: 'Lokaler Ordner', lastActive: 'Zuletzt aktiv', expand: 'Erweitern', usageLimits: 'Nutzungslimits', resets: 'Zurücksetzung', credits: 'Guthaben', unlimited: 'Unbegrenzt',
      ...
      insightTitles: { 'multi-agent-tax': 'Frische Nutzung durch Unter-Threads', 'effort-comparison': 'Eine niedrigere Aufwandsstufe vergleichen', 'post-patch-tool-call-intensity': 'Befehlsintensität nach Änderungen', 'cache-context': 'Cache- und Langkontext', 'approval-reviewer': 'Freigabe-Prüfer-Aufwand' },
    },
  ),
  'zh-TW': providerTranslations(
    { claude: 'Claude', codexBeta: 'Codex Beta', compare: '比較' },
    {
      ...
      unnamedSession: '未命名工作階段', unidentifiedProject: '未識別專案', parentThread: '父執行緒', searchThreads: '搜尋工作階段', all: '全部', localDirectory: '本機資料夾', lastActive: '最後活動', expand: '展開', usageLimits: '用量限制', resets: '重設時間', credits: '點數', unlimited: '無上限',
      ...
      insightTitles: { 'multi-agent-tax': '子執行緒的新鮮用量', 'effort-comparison': '比較低一級推理強度', 'post-patch-tool-call-intensity': '修改後命令密度', 'cache-context': '快取與長上下文解讀', 'approval-reviewer': '權限審批開銷' },
    },
  ),
  'zh-CN': providerTranslations(
    { claude: 'Claude', codexBeta: 'Codex Beta', compare: '对比' },
    {
      ...
      unnamedSession: '未命名会话', unidentifiedProject: '未识别项目', parentThread: '父线程', searchThreads: '搜索会话', all: '全部', localDirectory: '本地文件夹', lastActive: '最后活动', expand: '展开', usageLimits: '用量限制', resets: '重置时间', credits: '点数', unlimited: '无限制',
      ...
      insightTitles: { 'multi-agent-tax': '子线程的新鲜用量', 'effort-comparison': '对比低一级推理强度', 'post-patch-tool-call-intensity': '修改后命令密度', 'cache-context': '缓存与长上下文解读', 'approval-reviewer': '权限审批开销' },
    },
  ),
  ja: providerTranslations(
    { claude: 'Claude', codexBeta: 'Codex Beta', compare: '比較' },
    {
      ...
      unnamedSession: '名前のないセッション', unidentifiedProject: '未識別のプロジェクト', parentThread: '親スレッド', searchThreads: 'セッションを検索', all: 'すべて', localDirectory: 'ローカルフォルダー', lastActive: '最終アクティブ', expand: '展開', usageLimits: '使用量上限', resets: 'リセット', credits: 'クレジット', unlimited: '無制限',
      ...
      insightTitles: { 'multi-agent-tax': '子スレッドの新規使用量', 'effort-comparison': '1 段低い推論強度との比較', 'post-patch-tool-call-intensity': '変更後のコマンド密度', 'cache-context': 'キャッシュと長いコンテキスト', 'approval-reviewer': '承認レビュアーの負荷' },
    },
  ),
  ko: providerTranslations(
    { claude: 'Claude', codexBeta: 'Codex Beta', compare: '비교' },
    {
      ...
      unnamedSession: '이름 없는 세션', unidentifiedProject: '식별되지 않은 프로젝트', parentThread: '상위 스레드', searchThreads: '세션 검색', all: '전체', localDirectory: '로컬 폴더', lastActive: '마지막 활동', expand: '펼치기', usageLimits: '사용량 한도', resets: '재설정', credits: '크레딧', unlimited: '무제한',
      ...
      insightTitles: { 'multi-agent-tax': '하위 스레드의 새 사용량', 'effort-comparison': '한 단계 낮은 추론 강도 비교', 'post-patch-tool-call-intensity': '변경 후 명령 밀도', 'cache-context': '캐시 및 긴 컨텍스트', 'approval-reviewer': '승인 검토자 오버헤드' },
    },
  ),
  'pt-BR': providerTranslations(
    { claude: 'Claude', codexBeta: 'Codex Beta', compare: 'Comparar' },
    {
      ...
      unnamedSession: 'Sessão sem nome', unidentifiedProject: 'Projeto não identificado', parentThread: 'Thread pai', searchThreads: 'Pesquisar sessões', all: 'Tudo', localDirectory: 'Pasta local', lastActive: 'Última atividade', expand: 'Expandir', usageLimits: 'Limites de uso', resets: 'Redefinição', credits: 'Créditos', unlimited: 'Ilimitado',
      ...
      insightTitles: { 'multi-agent-tax': 'Uso novo das threads filhas', 'effort-comparison': 'Compare um nível de esforço menor', 'post-patch-tool-call-intensity': 'Intensidade de comandos após mudanças', 'cache-context': 'Cache e contexto longo', 'approval-reviewer': 'Sobrecarga do revisor de aprovação' },
    },
  ),
  id: providerTranslations(
    { claude: 'Claude', codexBeta: 'Codex Beta', compare: 'Bandingkan' },
    {
      ...
      unnamedSession: 'Sesi tanpa nama', unidentifiedProject: 'Proyek tidak teridentifikasi', parentThread: 'Thread induk', searchThreads: 'Cari sesi', all: 'Semua', localDirectory: 'Folder lokal', lastActive: 'Terakhir aktif', expand: 'Perluas', usageLimits: 'Batas penggunaan', resets: 'Reset', credits: 'Kredit', unlimited: 'Tanpa batas',
      ...
      insightTitles: { 'multi-agent-tax': 'Penggunaan baru thread anak', 'effort-comparison': 'Bandingkan satu tingkat upaya lebih rendah', 'post-patch-tool-call-intensity': 'Intensitas perintah setelah perubahan', 'cache-context': 'Cache dan konteks panjang', 'approval-reviewer': 'Beban peninjau persetujuan' },
    },
  ),
};
