...
const PROVIDERS: Record<SupportedLanguage, ProviderTranslations> = {
  ...
  'zh-TW': providerTranslations(
    { claude: 'Claude', codexBeta: 'Codex Beta', compare: '比較' },
    {
      ...
      unnamedSession: '未命名工作階段', unidentifiedProject: '未識別專案', parentThread: '父執行緒', parentTask: '父任務', searchThreads: '搜尋工作階段', sessions: '工作階段', modelsEffort: '模型與推理強度', clearFilters: '清除篩選條件', activeFilters: '作用中的篩選條件', all: '全部', localDirectory: '本機資料夾', lastActive: '最後活動', expand: '展開', usageLimits: '用量限制', resets: '重設時間', credits: '點數', unlimited: '無上限',
      allTime: '全部時間', behavior: '行為', settings: '設定', monthly: '按月', tokenComposition: 'Token 構成', freshInput: '新鮮輸入', reasoningSubset: '推理已包含在輸出中', threadRoleComposition: '執行緒角色構成', childThreadsPerRootTask: '每個根任務的子執行緒數', childFreshShare: '子執行緒新鮮用量占比', approvalFreshShare: '審批新鮮用量占比', highEffortFreshShare: '高推理強度新鮮用量占比', processedToFreshRatio: '已處理 / 新鮮用量', reasoningOutputShare: '推理占輸出比例', postPatchToolCallsPerPatchCall: '每次修補呼叫的修補後工具呼叫代理量', patchCalls: '修補呼叫次數', compactions: '上下文壓縮次數',
  ...
  'zh-CN': providerTranslations(
    { claude: 'Claude', codexBeta: 'Codex Beta', compare: '对比' },
    {
      ...
      title: 'Codex 用量', beta: 'Beta', overview: '概览', daily: '按日', date: '日期', role: '角色', scope: '范围', threadLabel: '线程', rootRole: '根任务', childRole: 'Subagent', approvalReviewerRole: '权限审批', unknownRole: '未知', noDailyData: '尚未索引到 Codex 每日用量。', noThreadData: '尚未索引到 Codex 线程。', lastTask: '最近任务', last7Days: '最近 7 天', last30Days: '最近 30 天', projects: '项目', projectLabel: '项目',
      unnamedSession: '未命名会话', unidentifiedProject: '未识别项目', parentThread: '父线程', parentTask: '父任务', searchThreads: '搜索会话', sessions: '会话', modelsEffort: '模型与推理强度', clearFilters: '清除筛选条件', activeFilters: '生效的筛选条件', all: '全部', localDirectory: '本地文件夹', lastActive: '最后活动', expand: '展开', usageLimits: '用量限制', resets: '重置时间', credits: '点数', unlimited: '无限制',
      allTime: '全部时间', behavior: '行为', settings: '设置', monthly: '按月', tokenComposition: 'Token 构成', freshInput: '新鲜输入', reasoningSubset: '推理已包含在输出中', threadRoleComposition: '线程角色构成', childThreadsPerRootTask: '每个根任务的子线程数', childFreshShare: '子线程新鲜用量占比', approvalFreshShare: '审批新鲜用量占比', highEffortFreshShare: '高推理强度新鲜用量占比', processedToFreshRatio: '已处理 / 新鲜用量', reasoningOutputShare: '推理占输出比例', postPatchToolCallsPerPatchCall: '每次补丁调用的补丁后工具调用代理量', patchCalls: '补丁调用次数', compactions: '上下文压缩次数',
  ...
  ja: providerTranslations(
    { claude: 'Claude', codexBeta: 'Codex Beta', compare: '比較' },
    {
      ...
      unnamedSession: '名前のないセッション', unidentifiedProject: '未識別のプロジェクト', parentThread: '親スレッド', parentTask: '親タスク', searchThreads: 'セッションを検索', sessions: 'セッション', modelsEffort: 'モデルと推論強度', clearFilters: 'フィルターをクリア', activeFilters: '適用中のフィルター', all: 'すべて', localDirectory: 'ローカルフォルダー', lastActive: '最終アクティブ', expand: '展開', usageLimits: '使用量上限', resets: 'リセット', credits: 'クレジット', unlimited: '無制限',
      allTime: '全期間', behavior: '行動', settings: '設定', monthly: '月別', tokenComposition: 'トークン構成', freshInput: '新規入力', reasoningSubset: '推論は出力に含まれます', threadRoleComposition: 'スレッド役割構成', childThreadsPerRootTask: 'ルートタスクあたりの子スレッド', childFreshShare: '子スレッドの新規使用量比率', approvalFreshShare: '承認の新規使用量比率', highEffortFreshShare: '高推論強度の新規使用量比率', processedToFreshRatio: '処理済み / 新規', reasoningOutputShare: '出力に占める推論', postPatchToolCallsPerPatchCall: 'パッチ呼び出しあたりのパッチ後ツール呼び出しプロキシ', patchCalls: 'パッチ呼び出し', compactions: 'コンテキスト圧縮',
  ...
  id: providerTranslations(
    { claude: 'Claude', codexBeta: 'Codex Beta', compare: 'Bandingkan' },
    {
      ...
      unnamedSession: 'Sesi tanpa nama', unidentifiedProject: 'Proyek tidak teridentifikasi', parentThread: 'Thread induk', parentTask: 'Tugas induk', searchThreads: 'Cari sesi', sessions: 'Sesi', modelsEffort: 'Model & upaya', clearFilters: 'Hapus filter', activeFilters: 'Filter aktif', all: 'Semua', localDirectory: 'Folder lokal', lastActive: 'Terakhir aktif', expand: 'Perluas', usageLimits: 'Batas penggunaan', resets: 'Reset', credits: 'Kredit', unlimited: 'Tanpa batas',
      allTime: 'Sepanjang waktu', behavior: 'Perilaku', settings: 'Pengaturan', monthly: 'Bulanan', tokenComposition: 'Komposisi token', freshInput: 'Input baru', reasoningSubset: 'Penalaran sudah termasuk dalam output', threadRoleComposition: 'Komposisi peran thread', childThreadsPerRootTask: 'Thread anak / tugas utama', childFreshShare: 'Porsi penggunaan baru thread anak', approvalFreshShare: 'Porsi penggunaan baru persetujuan', highEffortFreshShare: 'Porsi penggunaan baru effort tinggi', processedToFreshRatio: 'Diproses / baru', reasoningOutputShare: 'Porsi penalaran dalam output', postPatchToolCallsPerPatchCall: 'Proksi panggilan alat pasca-patch / panggilan patch', patchCalls: 'Panggilan patch', compactions: 'Pemadatan konteks',
