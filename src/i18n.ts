  ...
  en: {
    ...
    popup: {
      ...
      adviceEffectiveness: {
        ...
        candidateNotice: 'v2.3.1 candidate · off by default · no network transport connected.',
        ...
        payloadDescription: 'This sealed snapshot is the exact UTF-8 JSON body a future transport would receive.',
        ...
        noNetworkTransport: 'Preview only — this candidate has no network transport.',
        ...
        promptConsentLabel: 'Also include my prompt samples',
        promptConsentHelp: 'Optional and off by default. Bounded prompt text is added only after this separate explicit consent.',
  ...
  "de-DE": {
    ...
    popup: {
      ...
      adviceEffectiveness: {
        ...
        candidateNotice: 'v2.3.1-Kandidat · standardmäßig deaktiviert · keine Netzwerkübertragung verbunden.',
        ...
        payloadDescription: 'Diese versiegelte Momentaufnahme ist exakt der UTF-8-JSON-Body, den eine künftige Übertragung erhalten würde.',
        ...
        noNetworkTransport: 'Nur Vorschau — dieser Kandidat hat keine Netzwerkübertragung.',
        ...
        promptConsentLabel: 'Auch meine Prompt-Beispiele einschließen',
        promptConsentHelp: 'Optional und standardmäßig deaktiviert. Begrenzter Prompt-Text wird nur nach dieser separaten ausdrücklichen Einwilligung hinzugefügt.',
  ...
  'zh-TW': {
    ...
    popup: {
      ...
      adviceEffectiveness: {
        ...
        candidateNotice: 'v2.3.1 候選功能 · 預設關閉 · 尚未連接網路傳輸。',
        spineLabel: '建議證據路徑',
        observation: '觀察',
        evidence: '證據',
        recommendation: '建議',
        ...
        payloadDescription: '此密封快照就是未來傳輸會收到的確切 UTF-8 JSON body。',
        ...
        noNetworkTransport: '僅供預覽——此候選功能尚無網路傳輸。',
        aggregateConsentLabel: '允許使用彙總用量資料',
        aggregateConsentHelp: '只包含允許清單內的數值彙總與結構訊號——不含 prompt、路徑、工作階段 ID 或逐筆記錄。',
        promptConsentLabel: '同時包含我的 prompt 樣本',
        promptConsentHelp: '選用且預設關閉。只有在另行明確同意後，才會加入有數量與長度限制的 prompt 文字。',
  ...
  'zh-CN': {
    ...
    popup: {
      ...
      adviceEffectiveness: {
        ...
        candidateNotice: 'v2.3.1 候选功能 · 默认关闭 · 尚未连接网络传输。',
        spineLabel: '建议证据路径',
        observation: '观察',
        evidence: '证据',
        recommendation: '建议',
        ...
        payloadTitle: '密封 payload 快照',
        payloadDescription: '此密封快照就是未来传输会收到的确切 UTF-8 JSON body。',
        ...
        noNetworkTransport: '仅供预览——此候选功能尚无网络传输。',
        aggregateConsentLabel: '允许使用汇总用量数据',
        aggregateConsentHelp: '只包含允许列表内的数值汇总与结构信号——不含 prompt、路径、会话 ID 或逐条记录。',
        promptConsentLabel: '同时包含我的 prompt 样本',
        promptConsentHelp: '可选且默认关闭。只有另行明确同意后，才会加入有数量和长度限制的 prompt 文本。',
        feedbackTitle: '本地反馈',
        helpful: '有用',
        notHelpful: '无用',
        applied: '已应用',
  ...
  ja: {
    ...
    popup: {
      ...
      adviceEffectiveness: {
        ...
        candidateNotice: 'v2.3.1 候補機能 · デフォルトは無効 · ネットワーク転送は未接続です。',
        ...
        payloadDescription: 'この封印済みスナップショットは、将来の転送が受け取る UTF-8 JSON body と完全に同一です。',
        ...
        noNetworkTransport: 'プレビューのみ — この候補機能にはネットワーク転送がありません。',
        aggregateConsentLabel: '集計使用データを許可する',
        aggregateConsentHelp: '許可リスト内の数値集計と構造シグナルだけを含み、プロンプト、パス、セッション ID、個別レコードは含みません。',
        promptConsentLabel: '自分のプロンプト例も含める',
        promptConsentHelp: '任意で、デフォルトは無効です。この独立した明示的同意の後にだけ、件数と長さを制限したプロンプト本文を追加します。',
  ...
  ko: {
    ...
    popup: {
      ...
      adviceEffectiveness: {
        ...
        candidateNotice: 'v2.3.1 후보 기능 · 기본적으로 꺼짐 · 네트워크 전송이 연결되지 않음.',
        spineLabel: '조언 근거 경로',
        observation: '관찰',
        evidence: '근거',
        recommendation: '조언',
        ...
        payloadDescription: '이 봉인된 스냅샷은 향후 전송이 받게 될 UTF-8 JSON body와 정확히 같습니다.',
        ...
        noNetworkTransport: '미리보기 전용 — 이 후보 기능에는 네트워크 전송이 없습니다.',
        aggregateConsentLabel: '집계 사용량 데이터 허용',
        aggregateConsentHelp: '허용 목록의 수치 집계와 구조 신호만 포함하며 프롬프트, 경로, 세션 ID, 개별 레코드는 포함하지 않습니다.',
        promptConsentLabel: '내 프롬프트 샘플도 포함',
        promptConsentHelp: '선택 사항이며 기본적으로 꺼져 있습니다. 이 별도의 명시적 동의 후에만 개수와 길이가 제한된 프롬프트 텍스트를 추가합니다.',
  ...
  'pt-BR': {
    ...
    popup: {
      ...
      adviceEffectiveness: {
        ...
        candidateNotice: 'Candidato v2.3.1 · desativado por padrão · sem transporte de rede conectado.',
        ...
        payloadDescription: 'Este snapshot selado é exatamente o body JSON em UTF-8 que um transporte futuro receberia.',
        ...
        noNetworkTransport: 'Somente prévia — este candidato não tem transporte de rede.',
        ...
        promptConsentLabel: 'Incluir também minhas amostras de prompt',
        promptConsentHelp: 'Opcional e desativado por padrão. Texto de prompt com quantidade e tamanho limitados só é adicionado após este consentimento explícito separado.',
  ...
  id: {
    ...
    popup: {
      ...
      adviceEffectiveness: {
        ...
        candidateNotice: 'Kandidat v2.3.1 · nonaktif secara default · tidak ada transport jaringan yang terhubung.',
        ...
        payloadDescription: 'Snapshot tersegel ini persis sama dengan body JSON UTF-8 yang akan diterima transport mendatang.',
        ...
        noNetworkTransport: 'Hanya pratinjau — kandidat ini tidak memiliki transport jaringan.',
        ...
        promptConsentLabel: 'Sertakan juga sampel prompt saya',
        promptConsentHelp: 'Opsional dan nonaktif secara default. Teks prompt yang dibatasi jumlah dan panjangnya hanya ditambahkan setelah persetujuan eksplisit terpisah ini.',
...
const SETTINGS_I18N: Partial<Record<SupportedLanguage, Record<string, { label: string; help: string }>>> = {
  'de-DE': {
    ...
    'advice.effectiveness.enabled': { label: 'Vorschau zur Wirksamkeit von KI-Empfehlungen aktivieren', help: 'Standardmäßig aus. Zeigt den lokalen v2.3.1-Kandidaten für Evidenz, Payload-Vorschau, Feedback und Vergleich, ohne eine Netzwerkübertragung zu aktivieren.' },
  ...
  'zh-TW': {
    ...
    'advice.effectiveness.enabled': { label: '啟用 AI 建議有效性預覽', help: '預設關閉。顯示本機優先的 v2.3.1 候選證據、payload 預覽、回饋與比較介面，但不啟用網路傳輸。' },
  ...
  'zh-CN': {
    ...
    'advice.effectiveness.enabled': { label: '启用 AI 建议有效性预览', help: '默认关闭。显示本地优先的 v2.3.1 候选证据、payload 预览、反馈与比较界面，但不启用网络传输。' },
  ...
  'ja': {
    ...
    'advice.effectiveness.enabled': { label: 'AI アドバイス有効性プレビューを有効化', help: 'デフォルトは無効です。ネットワーク転送を有効にせず、ローカル優先の v2.3.1 候補の根拠、payload プレビュー、フィードバック、比較画面を表示します。' },
  ...
  'ko': {
    ...
    'advice.effectiveness.enabled': { label: 'AI 조언 효과성 미리보기 활성화', help: '기본적으로 꺼져 있습니다. 네트워크 전송을 활성화하지 않고 로컬 우선 v2.3.1 후보의 근거, payload 미리보기, 피드백, 비교 화면을 표시합니다.' },
  ...
  'pt-BR': {
    ...
    'advice.effectiveness.enabled': { label: 'Ativar prévia de eficácia dos conselhos de IA', help: 'Desativado por padrão. Mostra a interface local do candidato v2.3.1 para evidências, prévia de payload, feedback e comparação sem ativar transporte de rede.' },
  ...
  'id': {
    ...
    'advice.effectiveness.enabled': { label: 'Aktifkan pratinjau efektivitas saran AI', help: 'Nonaktif secara default. Menampilkan antarmuka kandidat v2.3.1 yang mengutamakan lokal untuk bukti, pratinjau payload, umpan balik, dan perbandingan tanpa mengaktifkan transport jaringan.' },
