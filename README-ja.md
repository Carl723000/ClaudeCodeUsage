...
![プロジェクト活動マトリクス、英語、ダークテーマ](images/v2.3.2/project-activity-matrix-en-dark.png)

上の5枚は本番ダッシュボードのレンダラー、合成データ、VS Code Light+/Dark+ のテーマ変数から生成しています。個人の使用量や請求の証拠ではありません。ネイティブ VSIX のインストールは別途検証します。
...
- Projects に、両プロバイダー共通の Token 専用30／90日「プロジェクト × 日」ヒートマップと日別積み上げ推移を追加しました。正確なツールチップ、カバレッジ表示、上限付き行数、「その他のプロジェクト」の長尾を備えます。
...
- **v2.3 系列全体の改善** — GPT-6 Astra と Fable 5.1 のモデル情報、任意の
  AWS Bedrock 料金、固定参照レートの表示通貨選択、Token 専用30／90日
  プロジェクト活動マトリクス、月・日・時間の完全なドリルダウン、状態を保つ更新、アクセシブルなチャート、watcher と
